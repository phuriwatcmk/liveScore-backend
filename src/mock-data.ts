...
export const mockFixturesToday = [
  {
    fixture: {
      id: 1001,
...
export const mockTeamsByLeague = [
  {
    league: {
      id: 39,
      name: "Premier League",
...
export const mockTeamFixturesStats = [
  {
    league: {
      id: 39,
      name: "Premier League",
...
export const mockH2HWithFixtures = [
  {
    league: {
      id: 39,
      name: "Premier League",
...
export const mockNews = [
  {
    ...
    summary:
      "เออร์ลิง เฮอร์แลนด์ เขียนประวัติศาสตร์ใหม่ด้วยการทำแฮตทริกภายใน 15 นาทีแรก นำแมนเชสเตอร์ ซิตี้ถล่มเชลซี 5-0 ที่เอติฮัด สเตเดียม คืนที่ผ่านมา สร้างสถิติการทำประตูเร็วที่สุดในประวัติศาสตร์พรีเมียร์ลีก",
    image:
  ...
  },
  {
    id: 2,
    title:
      "💰 เอ็มบัปเป้ยืนยันแล้ว! ย้ายเรอัล มาดริดฟรีทรานสเฟอร์ พร้อมเงินเซ็นสัญญา 150 ล้านยูโร",
    summary:
      "ผู้เล่นดาวฝรั่งเศสวัย 25 ปี ยืนยันการย้ายไปเรอัล มาดริดอย่างเป็นทางการ หลังสิ้นสุดสัญญากับปีเอสเช ด้วยข้อตกลงฟรีทรานสเฟอร์ พร้อมรับเงินค่าเซ็นสัญญาถึง 150 ล้านยูโร และค่าเหนื่อย 25 ล้านยูโรต่อปี เป็นระยะเวลา 5 ปี",
    image:
      "https://images.unsplash.com/photo-1551698618-1dfe5d97d256?w=800&h=400&fit=crop&crop=center",
  ...
  },
  {
    id: 3,
    title:
      "⚡ ลิเวอร์พูลสยบอาร์เซนอล 3-2 ในเกมมหากาพย์! คล็อปป์ชื่นชม 'ซาลาห์' ฟอร์มเทพ",
    summary:
      "ศึกระดับโลกที่แอนฟิลด์! ลิเวอร์พูลพลิกแซงอาร์เซนอล 3-2 ในเกมที่ตื่นเต้นจนวินาทีสุดท้าย โมฮาเหม็ด ซาลาห์ เป็นฮีโร่ยิงได้สองประตู รวมถึงประตูชัยในนาที 89 ทำให้ทีมเก็บ 3 แต้มสำคัญ",
    image:
      "https://images.unsplash.com/photo-1508098682722-e99c43a406b2?w=800&h=400&fit=crop&crop=center",
  ...
  },
  {
    ...
    summary:
      "ความสำเร็จอันยิ่งใหญ่! นาโปลี ซิวแชมป์เซเรียอา 2024-25 อย่างเป็นทางการ หลังมีแต้มนำจุดที่สองถึง 18 แต้ม ขณะเหลือเพียง 11 นัดสุดท้าย วิคเตอร์ โอซิมเฮน ยิงไป 28 ประตู เป็นตัวหลักพาทีมคว้าแชมป์สมัยที่ 4 ในประวัติศาสตร์",
    image:
      "https://images.unsplash.com/photo-1431324155629-1a6deb1dec8d?w=800&h=400&fit=crop&crop=center",
  ...
  },
  {
    ...
    summary:
      "ทีมชาติไทย เฮแพ้ซิงคโปร์ 2-1 ในเกมคัดเลือกฟุตบอลโลก 2026 รอบแรก ที่สนามราชมังคลา ด้วยประตูของ ซุปไตซิน ชาติใต้ (2 ประตู) พาช้างศึกขึ้นจ่าฝูงกลุ่มด้วย 12 แต้มจาก 5 เกม ใกล้เข้ารอบต่อไปแล้ว",
    image:
  ...
  },
  {
    id: 6,
    title:
      "🎯 ผู้จัดการทีมใหม่! ยูเวนตุสแต่งตั้ง 'อันเชล็อตติ' คุมทีมแทน 'อัลเลกรี'",
    summary:
      "การเปลี่ยนแปลงครั้งใหม่ที่ตูริน! ยูเวนตุส ประกาศแต่งตั้ง คาร์โล อันเชล็อตติ เป็นผู้จัดการทีมคนใหม่ ด้วยสัญญา 3 ปี หลังเจรจาตัวสำเร็จจากเรอัล มาดริด อัลเลกรี จะยุติบทบาทหลังนำทีมได้แชมป์คอปปา อิตาเลียเมื่อเดือนที่แล้ว",
    image:
      "https://images.unsplash.com/photo-1489944440615-453fc2b6a9a9?w=800&h=400&fit=crop&crop=center",
  ...
  },
  {
    id: 7,
    title:
      "⚽ บาเยิร์นเจ๋ง! คว้าตัว 'เบลลิงแฮม' จากดอร์ทมุนด์ด้วยค่าตัวสถิติโลก 180 ล้านยูโร",
    summary:
      "ดีลระเบิดโลก! บาเยิร์น มิวนิค ประกาศคว้าตัว จูด เบลลิงแฮม กองกลางดาวรุ่งอังกฤษจากดอร์ทมุนด์ สำเร็จ ด้วยค่าตัว 180 ล้านยูโร ทำลายสถิติการซื้อนักเตะที่แพงที่สุดในประวัติศาสตร์บุนเดสลีกา สัญญา 6 ปี เริ่มฤดูกาลหน้า",
    image:
      "https://images.unsplash.com/photo-1577223625816-7546f13df25d?w=800&h=400&fit=crop&crop=center",
  ...
  },
  {
    id: 8,
    title:
      "🌟 'เมสซี่' ทำได้อีกแล้ว! คว้าลูกทองคำครั้งที่ 8 ในวัย 37 ปี เขียนประวัติศาสตร์ใหม่",
    summary:
      "ประวัติศาสตร์เขียนใหม่! ลิโอเนล เมสซี่ คว้ารางวัลบัลลงดอร์ครั้งที่ 8 ในอาชีพ ทำลายสถิติตัวเองหลังนำอาร์เจนตินาซิวแชมป์โลก และมีฟอร์มเจิดจรัสกับอินเตอร์ ไมอามี่ ในวัย 37 ปี ยืนยันตำแหน่งนักเตะที่ยิ่งใหญ่ที่สุดแห่งยุค",
    image:
      "https://images.unsplash.com/photo-1579952363873-27d3bfad9c0d?w=800&h=400&fit=crop&crop=center",
  ...
  },
  {
    id: 9,
    title:
      "🚨 ข่าวลือร้อน! 'เนย์มาร์' เตรียมกลับยุโรป พีเอสเชเล็งคว้าตัวจากซาอุดิฯ",
    summary:
      "ความเป็นไปได้ที่น่าตื่นเต้น! เนย์มาร์ ดาวเก๋าบราซิล อาจกลับสู่ยุโรปอีกครั้ง หลังปีเอสเช เริ่มเจรจาอย่างจริงจังกับอัล ฮิลาล เพื่อคว้าตัวกลับมาปารีส ด้วยข้อเสนอค่าตัว 60 ล้านยูโร พร้อมค่าเหนื่อย 15 ล้านยูโรต่อปี เป็นสัญญา 2 ปี",
    image:
  ...
  },
  {
    id: 10,
    title:
      "🏟️ ยูฟ่าเผยโฉม! สเตเดียมใหม่สำหรับยูโร 2028 ที่อังกฤษ งบ 2.5 พันล้านปอนด์",
    summary:
      "แผนการยิ่งใหญ่เผยโฉม! ยูฟ่า ร่วมกับสมาคมฟุตบอลอังกฤษเปิดตัวแผนสร้างสนามกีฬาแห่งใหม่ 5 แห่ง สำหรับการแข่งขันยูโร 2028 ด้วยงบประมาณรวม 2.5 พันล้านปอนด์ รองรับผู้ชมได้มากถึง 90,000 คน พร้อมเทคโนโลยีล้ำสมัย",
    image:
      "https://images.unsplash.com/photo-1459865264687-595d652de67e?w=800&h=400&fit=crop&crop=center",
